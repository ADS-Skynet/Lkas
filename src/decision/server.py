...
class DecisionServer:
    ...
    def __init__(
        ...
        if hasattr(self.controller.controller, 'lookahead_ratio'):
        ...
        print(f"  Gain={config.controller.kp}, Heading={config.controller.kd}, Lookahead={config.controller.lookahead_ratio}")
